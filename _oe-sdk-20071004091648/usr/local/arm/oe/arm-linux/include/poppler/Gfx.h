...
// iRex, RenderRet is used to check render result
enum RenderRet
{
    Render_Done = 0,        // render correctly
    Render_Error = 1,       // something wrong during rendering
    Render_Abort = 2,       // aborted by caller
...
public:
  ...
  RenderRet display(Object *obj, GBool topLevel = gTrue);
