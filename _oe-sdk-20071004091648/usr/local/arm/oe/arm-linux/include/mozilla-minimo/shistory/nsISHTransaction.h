/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/docshell/shistory/public/nsISHTransaction.idl
 */
...
class NS_NO_VTABLE nsISHTransaction : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISHTRANSACTION_IID)
  ...
  NS_IMETHOD GetPersist(PRBool *aPersist) = 0;
  NS_IMETHOD SetPersist(PRBool aPersist) = 0;
...
#define NS_DECL_NSISHTRANSACTION \
  ...
  NS_IMETHOD GetPersist(PRBool *aPersist); \
  NS_IMETHOD SetPersist(PRBool aPersist); \
...
#define NS_FORWARD_NSISHTRANSACTION(_to) \
  ...
  NS_IMETHOD GetPersist(PRBool *aPersist) { return _to GetPersist(aPersist); } \
  NS_IMETHOD SetPersist(PRBool aPersist) { return _to SetPersist(aPersist); } \
...
#define NS_FORWARD_SAFE_NSISHTRANSACTION(_to) \
  ...
  NS_IMETHOD GetPersist(PRBool *aPersist) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPersist(aPersist); } \
  NS_IMETHOD SetPersist(PRBool aPersist) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPersist(aPersist); } \
