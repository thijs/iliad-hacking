/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/docshell/shistory/public/nsISHContainer.idl
 */
...
class NS_NO_VTABLE nsISHContainer : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISHCONTAINER_IID)
  ...
  NS_IMETHOD AddChild(nsISHEntry *child, PRInt32 offset) = 0;
  ...
  NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval) = 0;
...
#define NS_DECL_NSISHCONTAINER \
  ...
  NS_IMETHOD AddChild(nsISHEntry *child, PRInt32 offset); \
  NS_IMETHOD RemoveChild(nsISHEntry *child); \
  NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval); 
...
#define NS_FORWARD_NSISHCONTAINER(_to) \
  ...
  NS_IMETHOD AddChild(nsISHEntry *child, PRInt32 offset) { return _to AddChild(child, offset); } \
  NS_IMETHOD RemoveChild(nsISHEntry *child) { return _to RemoveChild(child); } \
  NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval) { return _to GetChildAt(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSISHCONTAINER(_to) \
  ...
  NS_IMETHOD AddChild(nsISHEntry *child, PRInt32 offset) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddChild(child, offset); } \
  NS_IMETHOD RemoveChild(nsISHEntry *child) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveChild(child); } \
  NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChildAt(index, _retval); } 
