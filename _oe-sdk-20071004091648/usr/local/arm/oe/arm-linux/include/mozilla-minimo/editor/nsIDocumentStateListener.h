/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/editor/idl/nsIDocumentStateListener.idl
 */
...
class NS_NO_VTABLE nsIDocumentStateListener : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IDOCUMENTSTATELISTENER_IID)
  ...
  NS_IMETHOD NotifyDocumentStateChanged(PRBool nowDirty) = 0;
...
#define NS_FORWARD_NSIDOCUMENTSTATELISTENER(_to) \
  ...
  NS_IMETHOD NotifyDocumentStateChanged(PRBool nowDirty) { return _to NotifyDocumentStateChanged(nowDirty); } 
...
#define NS_FORWARD_SAFE_NSIDOCUMENTSTATELISTENER(_to) \
  ...
  NS_IMETHOD NotifyDocumentStateChanged(PRBool nowDirty) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyDocumentStateChanged(nowDirty); } 
