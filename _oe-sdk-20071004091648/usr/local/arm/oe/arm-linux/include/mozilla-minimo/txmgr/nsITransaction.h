/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/editor/txmgr/idl/nsITransaction.idl
 */
...
class NS_NO_VTABLE nsITransaction : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITRANSACTION_IID)
  ...
  NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval) = 0;
...
#define NS_DECL_NSITRANSACTION \
  ...
  NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval); 
...
#define NS_FORWARD_NSITRANSACTION(_to) \
  ...
  NS_IMETHOD GetIsTransient(PRBool *aIsTransient) { return _to GetIsTransient(aIsTransient); } \
  NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval) { return _to Merge(aTransaction, _retval); } 
...
#define NS_FORWARD_SAFE_NSITRANSACTION(_to) \
  ...
  NS_IMETHOD GetIsTransient(PRBool *aIsTransient) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsTransient(aIsTransient); } \
  NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Merge(aTransaction, _retval); } 
