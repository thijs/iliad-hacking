/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFPropagatableDataSource.idl
 */
...
class NS_NO_VTABLE nsIRDFPropagatableDataSource : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IRDFPROPAGATABLEDATASOURCE_IID)
  ...
  NS_IMETHOD GetPropagateChanges(PRBool *aPropagateChanges) = 0;
  NS_IMETHOD SetPropagateChanges(PRBool aPropagateChanges) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIRDFPROPAGATABLEDATASOURCE \
  NS_IMETHOD GetPropagateChanges(PRBool *aPropagateChanges); \
  NS_IMETHOD SetPropagateChanges(PRBool aPropagateChanges); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFPROPAGATABLEDATASOURCE(_to) \
  NS_IMETHOD GetPropagateChanges(PRBool *aPropagateChanges) { return _to GetPropagateChanges(aPropagateChanges); } \
  NS_IMETHOD SetPropagateChanges(PRBool aPropagateChanges) { return _to SetPropagateChanges(aPropagateChanges); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFPROPAGATABLEDATASOURCE(_to) \
  NS_IMETHOD GetPropagateChanges(PRBool *aPropagateChanges) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPropagateChanges(aPropagateChanges); } \
  NS_IMETHOD SetPropagateChanges(PRBool aPropagateChanges) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPropagateChanges(aPropagateChanges); } 
