/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/intl/lwbrk/idl/nsISemanticUnitScanner.idl
 */
...
class NS_NO_VTABLE nsISemanticUnitScanner : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISEMANTICUNITSCANNER_IID)
  ...
  NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval) = 0;
...
#define NS_DECL_NSISEMANTICUNITSCANNER \
  ...
  NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval); 
...
#define NS_FORWARD_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval) { return _to Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
...
#define NS_FORWARD_SAFE_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
