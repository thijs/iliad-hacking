/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFCompositeDataSource.idl
 */
...
class NS_NO_VTABLE nsIRDFCompositeDataSource : public nsIRDFDataSource {
 public: 
  ...
  NS_IMETHOD GetAllowNegativeAssertions(PRBool *aAllowNegativeAssertions) = 0;
  NS_IMETHOD SetAllowNegativeAssertions(PRBool aAllowNegativeAssertions) = 0;
  ...
  NS_IMETHOD GetCoalesceDuplicateArcs(PRBool *aCoalesceDuplicateArcs) = 0;
  NS_IMETHOD SetCoalesceDuplicateArcs(PRBool aCoalesceDuplicateArcs) = 0;
...
#define NS_DECL_NSIRDFCOMPOSITEDATASOURCE \
  NS_IMETHOD GetAllowNegativeAssertions(PRBool *aAllowNegativeAssertions); \
  NS_IMETHOD SetAllowNegativeAssertions(PRBool aAllowNegativeAssertions); \
  NS_IMETHOD GetCoalesceDuplicateArcs(PRBool *aCoalesceDuplicateArcs); \
  NS_IMETHOD SetCoalesceDuplicateArcs(PRBool aCoalesceDuplicateArcs); \
...
#define NS_FORWARD_NSIRDFCOMPOSITEDATASOURCE(_to) \
  NS_IMETHOD GetAllowNegativeAssertions(PRBool *aAllowNegativeAssertions) { return _to GetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_IMETHOD SetAllowNegativeAssertions(PRBool aAllowNegativeAssertions) { return _to SetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_IMETHOD GetCoalesceDuplicateArcs(PRBool *aCoalesceDuplicateArcs) { return _to GetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
  NS_IMETHOD SetCoalesceDuplicateArcs(PRBool aCoalesceDuplicateArcs) { return _to SetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
...
#define NS_FORWARD_SAFE_NSIRDFCOMPOSITEDATASOURCE(_to) \
  NS_IMETHOD GetAllowNegativeAssertions(PRBool *aAllowNegativeAssertions) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_IMETHOD SetAllowNegativeAssertions(PRBool aAllowNegativeAssertions) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAllowNegativeAssertions(aAllowNegativeAssertions); } \
  NS_IMETHOD GetCoalesceDuplicateArcs(PRBool *aCoalesceDuplicateArcs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
  NS_IMETHOD SetCoalesceDuplicateArcs(PRBool aCoalesceDuplicateArcs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCoalesceDuplicateArcs(aCoalesceDuplicateArcs); } \
