/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/intl/chardet/public/nsICharsetResolver.idl
 */
...
class NS_NO_VTABLE nsICharsetResolver : public nsISupports {
 public: 
  ...
  NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, PRBool *aWantCharset, nsISupports **aClosure, nsACString & _retval) = 0;
...
#define NS_DECL_NSICHARSETRESOLVER \
  NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, PRBool *aWantCharset, nsISupports **aClosure, nsACString & _retval); \
...
#define NS_FORWARD_NSICHARSETRESOLVER(_to) \
  NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, PRBool *aWantCharset, nsISupports **aClosure, nsACString & _retval) { return _to RequestCharset(aWebNavigation, aChannel, aWantCharset, aClosure, _retval); } \
...
#define NS_FORWARD_SAFE_NSICHARSETRESOLVER(_to) \
  NS_IMETHOD RequestCharset(nsIWebNavigation *aWebNavigation, nsIChannel *aChannel, PRBool *aWantCharset, nsISupports **aClosure, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RequestCharset(aWebNavigation, aChannel, aWantCharset, aClosure, _retval); } \
