/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/webshell/public/nsIContentViewerContainer.idl
 */
...
class NS_NO_VTABLE nsIContentViewerContainer : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICONTENTVIEWERCONTAINER_IID)
  ...
  NS_IMETHOD SetIsPrinting(PRBool aIsPrinting) = 0;
...
#define NS_DECL_NSICONTENTVIEWERCONTAINER \
  ...
  NS_IMETHOD SetIsPrinting(PRBool aIsPrinting); 
...
#define NS_FORWARD_NSICONTENTVIEWERCONTAINER(_to) \
  ...
  NS_IMETHOD SetIsPrinting(PRBool aIsPrinting) { return _to SetIsPrinting(aIsPrinting); } 
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWERCONTAINER(_to) \
  ...
  NS_IMETHOD SetIsPrinting(PRBool aIsPrinting) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsPrinting(aIsPrinting); } 
