/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFContainer.idl
 */
...
class NS_NO_VTABLE nsIRDFContainer : public nsISupports {
 public: 
  ...
  NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval) = 0;
...
#define NS_FORWARD_NSIRDFCONTAINER(_to) \
  ...
  NS_IMETHOD GetCount(PRInt32 *_retval) { return _to GetCount(_retval); } \
  ...
  NS_IMETHOD RemoveElement(nsIRDFNode *aElement, PRBool aRenumber) { return _to RemoveElement(aElement, aRenumber); } \
  NS_IMETHOD InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, PRBool aRenumber) { return _to InsertElementAt(aElement, aIndex, aRenumber); } \
  NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval) { return _to RemoveElementAt(aIndex, aRenumber, _retval); } \
  NS_IMETHOD IndexOf(nsIRDFNode *aElement, PRInt32 *_retval) { return _to IndexOf(aElement, _retval); } 
...
#define NS_FORWARD_SAFE_NSIRDFCONTAINER(_to) \
  ...
  NS_IMETHOD GetCount(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCount(_retval); } \
  ...
  NS_IMETHOD RemoveElement(nsIRDFNode *aElement, PRBool aRenumber) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveElement(aElement, aRenumber); } \
  NS_IMETHOD InsertElementAt(nsIRDFNode *aElement, PRInt32 aIndex, PRBool aRenumber) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertElementAt(aElement, aIndex, aRenumber); } \
  NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveElementAt(aIndex, aRenumber, _retval); } \
  NS_IMETHOD IndexOf(nsIRDFNode *aElement, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IndexOf(aElement, _retval); } 
