/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/editor/idl/nsIHTMLObjectResizeListener.idl
 */
...
class NS_NO_VTABLE nsIHTMLObjectResizeListener : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IHTMLOBJECTRESIZELISTENER_IID)
  ...
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, PRInt32 aOldWidth, PRInt32 aOldHeight, PRInt32 aNewWidth, PRInt32 aNewHeight) = 0;
...
#define NS_DECL_NSIHTMLOBJECTRESIZELISTENER \
  ...
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, PRInt32 aOldWidth, PRInt32 aOldHeight, PRInt32 aNewWidth, PRInt32 aNewHeight); 
...
#define NS_FORWARD_NSIHTMLOBJECTRESIZELISTENER(_to) \
  ...
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, PRInt32 aOldWidth, PRInt32 aOldHeight, PRInt32 aNewWidth, PRInt32 aNewHeight) { return _to OnEndResizing(aElement, aOldWidth, aOldHeight, aNewWidth, aNewHeight); } 
...
#define NS_FORWARD_SAFE_NSIHTMLOBJECTRESIZELISTENER(_to) \
  ...
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, PRInt32 aOldWidth, PRInt32 aOldHeight, PRInt32 aNewWidth, PRInt32 aNewHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnEndResizing(aElement, aOldWidth, aOldHeight, aNewWidth, aNewHeight); } 
