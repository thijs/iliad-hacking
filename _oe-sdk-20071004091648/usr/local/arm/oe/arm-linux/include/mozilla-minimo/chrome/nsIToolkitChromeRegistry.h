/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/chrome/public/nsIToolkitChromeRegistry.idl
 */
...
class NS_NO_VTABLE nsIToolkitChromeRegistry : public nsIXULChromeRegistry {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITOOLKITCHROMEREGISTRY_IID)
  ...
  NS_IMETHOD ProcessContentsManifest(nsIURI *aOldManifestURI, nsIURI *aFile, nsIURI *aBaseURI, PRBool aAppend, PRBool aSkinOnly) = 0;
...
#define NS_DECL_NSITOOLKITCHROMEREGISTRY \
  NS_IMETHOD ProcessContentsManifest(nsIURI *aOldManifestURI, nsIURI *aFile, nsIURI *aBaseURI, PRBool aAppend, PRBool aSkinOnly); \
...
#define NS_FORWARD_NSITOOLKITCHROMEREGISTRY(_to) \
  NS_IMETHOD ProcessContentsManifest(nsIURI *aOldManifestURI, nsIURI *aFile, nsIURI *aBaseURI, PRBool aAppend, PRBool aSkinOnly) { return _to ProcessContentsManifest(aOldManifestURI, aFile, aBaseURI, aAppend, aSkinOnly); } \
...
#define NS_FORWARD_SAFE_NSITOOLKITCHROMEREGISTRY(_to) \
  NS_IMETHOD ProcessContentsManifest(nsIURI *aOldManifestURI, nsIURI *aFile, nsIURI *aBaseURI, PRBool aAppend, PRBool aSkinOnly) { return !_to ? NS_ERROR_NULL_POINTER : _to->ProcessContentsManifest(aOldManifestURI, aFile, aBaseURI, aAppend, aSkinOnly); } \
