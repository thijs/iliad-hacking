/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/security/manager/pki/public/nsIASN1Tree.idl
 */
...
class NS_NO_VTABLE nsIASN1Tree : public nsITreeView {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IASN1TREE_IID)
  ...
  NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval) = 0;
...
#define NS_DECL_NSIASN1TREE \
  ...
  NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval); 
...
#define NS_FORWARD_NSIASN1TREE(_to) \
  ...
  NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval) { return _to GetDisplayData(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIASN1TREE(_to) \
  ...
  NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDisplayData(index, _retval); } 
