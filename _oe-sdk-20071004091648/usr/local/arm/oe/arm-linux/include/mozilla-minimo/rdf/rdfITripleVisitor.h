/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/rdfITripleVisitor.idl
 */
...
class NS_NO_VTABLE rdfITripleVisitor : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(RDFITRIPLEVISITOR_IID)
  ...
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, PRBool aTruthValue) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_RDFITRIPLEVISITOR \
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, PRBool aTruthValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_RDFITRIPLEVISITOR(_to) \
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, PRBool aTruthValue) { return _to Visit(aSubject, aPredicate, aObject, aTruthValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_RDFITRIPLEVISITOR(_to) \
  NS_IMETHOD Visit(nsIRDFNode *aSubject, nsIRDFResource *aPredicate, nsIRDFNode *aObject, PRBool aTruthValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->Visit(aSubject, aPredicate, aObject, aTruthValue); } 
