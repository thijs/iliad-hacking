/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/editor/idl/nsIURIRefObject.idl
 */
...
class NS_NO_VTABLE nsIURIRefObject : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IURIREFOBJECT_IID)
  ...
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, PRBool aMakeRel) = 0;
...
#define NS_DECL_NSIURIREFOBJECT \
  ...
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, PRBool aMakeRel); 
...
#define NS_FORWARD_NSIURIREFOBJECT(_to) \
  ...
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, PRBool aMakeRel) { return _to RewriteAllURIs(aOldPat, aNewPat, aMakeRel); } 
...
#define NS_FORWARD_SAFE_NSIURIREFOBJECT(_to) \
  ...
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, PRBool aMakeRel) { return !_to ? NS_ERROR_NULL_POINTER : _to->RewriteAllURIs(aOldPat, aNewPat, aMakeRel); } 
