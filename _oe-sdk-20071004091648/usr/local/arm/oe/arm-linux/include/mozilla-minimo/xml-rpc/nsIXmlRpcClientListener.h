/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/extensions/xml-rpc/idl/nsIXmlRpcClientListener.idl
 */
...
class NS_NO_VTABLE nsIXmlRpcClientListener : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXMLRPCCLIENTLISTENER_IID)
  ...
  NS_IMETHOD OnResult(nsIXmlRpcClient *client, nsISupports *ctxt, nsISupports *result) = 0;
  ...
  NS_IMETHOD OnFault(nsIXmlRpcClient *client, nsISupports *ctxt, nsIXmlRpcFault *fault) = 0;
  ...
  NS_IMETHOD OnError(nsIXmlRpcClient *client, nsISupports *ctxt, nsresult status, const PRUnichar *errorMsg) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXMLRPCCLIENTLISTENER \
  NS_IMETHOD OnResult(nsIXmlRpcClient *client, nsISupports *ctxt, nsISupports *result); \
  NS_IMETHOD OnFault(nsIXmlRpcClient *client, nsISupports *ctxt, nsIXmlRpcFault *fault); \
  NS_IMETHOD OnError(nsIXmlRpcClient *client, nsISupports *ctxt, nsresult status, const PRUnichar *errorMsg); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXMLRPCCLIENTLISTENER(_to) \
  NS_IMETHOD OnResult(nsIXmlRpcClient *client, nsISupports *ctxt, nsISupports *result) { return _to OnResult(client, ctxt, result); } \
  NS_IMETHOD OnFault(nsIXmlRpcClient *client, nsISupports *ctxt, nsIXmlRpcFault *fault) { return _to OnFault(client, ctxt, fault); } \
  NS_IMETHOD OnError(nsIXmlRpcClient *client, nsISupports *ctxt, nsresult status, const PRUnichar *errorMsg) { return _to OnError(client, ctxt, status, errorMsg); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXMLRPCCLIENTLISTENER(_to) \
  NS_IMETHOD OnResult(nsIXmlRpcClient *client, nsISupports *ctxt, nsISupports *result) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnResult(client, ctxt, result); } \
  NS_IMETHOD OnFault(nsIXmlRpcClient *client, nsISupports *ctxt, nsIXmlRpcFault *fault) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnFault(client, ctxt, fault); } \
  NS_IMETHOD OnError(nsIXmlRpcClient *client, nsISupports *ctxt, nsresult status, const PRUnichar *errorMsg) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnError(client, ctxt, status, errorMsg); } 
