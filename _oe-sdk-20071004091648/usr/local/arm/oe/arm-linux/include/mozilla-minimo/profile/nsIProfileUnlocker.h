/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/profile/public/nsIProfileUnlocker.idl
 */
...
class NS_NO_VTABLE nsIProfileUnlocker : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IPROFILEUNLOCKER_IID)
  ...
  NS_IMETHOD Unlock(PRUint32 aSeverity) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIPROFILEUNLOCKER \
  NS_IMETHOD Unlock(PRUint32 aSeverity); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROFILEUNLOCKER(_to) \
  NS_IMETHOD Unlock(PRUint32 aSeverity) { return _to Unlock(aSeverity); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROFILEUNLOCKER(_to) \
  NS_IMETHOD Unlock(PRUint32 aSeverity) { return !_to ? NS_ERROR_NULL_POINTER : _to->Unlock(aSeverity); } 
