/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/toolkit/components/autocomplete/public/nsIAutoCompleteSearch.idl
 */
...
class NS_NO_VTABLE nsIAutoCompleteSearch : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IAUTOCOMPLETESEARCH_IID)
...
class NS_NO_VTABLE nsIAutoCompleteObserver : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IAUTOCOMPLETEOBSERVER_IID)
