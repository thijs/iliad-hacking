/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/intl/chardet/public/nsIDocumentCharsetInfo.idl
 */
...
class NS_NO_VTABLE nsIDocumentCharsetInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetForcedDetector(PRBool *aForcedDetector) = 0;
  NS_IMETHOD SetForcedDetector(PRBool aForcedDetector) = 0;
  ...
  NS_IMETHOD GetParentCharsetSource(PRInt32 *aParentCharsetSource) = 0;
  NS_IMETHOD SetParentCharsetSource(PRInt32 aParentCharsetSource) = 0;
...
#define NS_DECL_NSIDOCUMENTCHARSETINFO \
  ...
  NS_IMETHOD GetForcedDetector(PRBool *aForcedDetector); \
  NS_IMETHOD SetForcedDetector(PRBool aForcedDetector); \
  NS_IMETHOD GetParentCharset(nsIAtom * *aParentCharset); \
  NS_IMETHOD SetParentCharset(nsIAtom * aParentCharset); \
  NS_IMETHOD GetParentCharsetSource(PRInt32 *aParentCharsetSource); \
  NS_IMETHOD SetParentCharsetSource(PRInt32 aParentCharsetSource); 
...
#define NS_FORWARD_NSIDOCUMENTCHARSETINFO(_to) \
  ...
  NS_IMETHOD GetForcedDetector(PRBool *aForcedDetector) { return _to GetForcedDetector(aForcedDetector); } \
  NS_IMETHOD SetForcedDetector(PRBool aForcedDetector) { return _to SetForcedDetector(aForcedDetector); } \
  ...
  NS_IMETHOD GetParentCharsetSource(PRInt32 *aParentCharsetSource) { return _to GetParentCharsetSource(aParentCharsetSource); } \
  NS_IMETHOD SetParentCharsetSource(PRInt32 aParentCharsetSource) { return _to SetParentCharsetSource(aParentCharsetSource); } 
...
#define NS_FORWARD_SAFE_NSIDOCUMENTCHARSETINFO(_to) \
  ...
  NS_IMETHOD GetForcedDetector(PRBool *aForcedDetector) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetForcedDetector(aForcedDetector); } \
  NS_IMETHOD SetForcedDetector(PRBool aForcedDetector) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetForcedDetector(aForcedDetector); } \
  ...
  NS_IMETHOD GetParentCharsetSource(PRInt32 *aParentCharsetSource) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetParentCharsetSource(aParentCharsetSource); } \
  NS_IMETHOD SetParentCharsetSource(PRInt32 aParentCharsetSource) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetParentCharsetSource(aParentCharsetSource); } 
