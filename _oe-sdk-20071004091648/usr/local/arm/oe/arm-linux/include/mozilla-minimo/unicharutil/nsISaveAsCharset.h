/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/intl/unicharutil/idl/nsISaveAsCharset.idl
 */
...
class NS_NO_VTABLE nsISaveAsCharset : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISAVEASCHARSET_IID)
  ...
  NS_IMETHOD Init(const char *charset, PRUint32 attr, PRUint32 entityVersion) = 0;
...
#define NS_FORWARD_NSISAVEASCHARSET(_to) \
  ...
  NS_IMETHOD Init(const char *charset, PRUint32 attr, PRUint32 entityVersion) { return _to Init(charset, attr, entityVersion); } \
...
#define NS_FORWARD_SAFE_NSISAVEASCHARSET(_to) \
  ...
  NS_IMETHOD Init(const char *charset, PRUint32 attr, PRUint32 entityVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(charset, attr, entityVersion); } \
