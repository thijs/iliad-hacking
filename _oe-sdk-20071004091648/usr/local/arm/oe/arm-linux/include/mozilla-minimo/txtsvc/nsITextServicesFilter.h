/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/editor/txtsvc/public/nsITextServicesFilter.idl
 */
...
class NS_NO_VTABLE nsITextServicesFilter : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ITEXTSERVICESFILTER_IID)
  ...
  NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSITEXTSERVICESFILTER \
  NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITEXTSERVICESFILTER(_to) \
  NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval) { return _to Skip(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITEXTSERVICESFILTER(_to) \
  NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Skip(aNode, _retval); } 
