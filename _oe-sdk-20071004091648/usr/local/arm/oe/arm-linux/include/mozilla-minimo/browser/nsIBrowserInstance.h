/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/xpfe/browser/public/nsIBrowserInstance.idl
 */
...
class NS_NO_VTABLE nsIBrowserInstance : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IBROWSERINSTANCE_IID)

  /* boolean startPageCycler (); */
  NS_IMETHOD StartPageCycler(PRBool *_retval) = 0;

  /* attribute boolean cmdLineURLUsed; */
  NS_IMETHOD GetCmdLineURLUsed(PRBool *aCmdLineURLUsed) = 0;
  NS_IMETHOD SetCmdLineURLUsed(PRBool aCmdLineURLUsed) = 0;

  /* void setWebShellWindow (in nsIDOMWindowInternal aWindow); */
  NS_IMETHOD SetWebShellWindow(nsIDOMWindowInternal *aWindow) = 0;
...
#define NS_DECL_NSIBROWSERINSTANCE \
  NS_IMETHOD StartPageCycler(PRBool *_retval); \
  NS_IMETHOD GetCmdLineURLUsed(PRBool *aCmdLineURLUsed); \
  NS_IMETHOD SetCmdLineURLUsed(PRBool aCmdLineURLUsed); \
  NS_IMETHOD SetWebShellWindow(nsIDOMWindowInternal *aWindow); \
  NS_IMETHOD Close(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIBROWSERINSTANCE(_to) \
  NS_IMETHOD StartPageCycler(PRBool *_retval) { return _to StartPageCycler(_retval); } \
  NS_IMETHOD GetCmdLineURLUsed(PRBool *aCmdLineURLUsed) { return _to GetCmdLineURLUsed(aCmdLineURLUsed); } \
  NS_IMETHOD SetCmdLineURLUsed(PRBool aCmdLineURLUsed) { return _to SetCmdLineURLUsed(aCmdLineURLUsed); } \
  NS_IMETHOD SetWebShellWindow(nsIDOMWindowInternal *aWindow) { return _to SetWebShellWindow(aWindow); } \
  NS_IMETHOD Close(void) { return _to Close(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIBROWSERINSTANCE(_to) \
  NS_IMETHOD StartPageCycler(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartPageCycler(_retval); } \
  NS_IMETHOD GetCmdLineURLUsed(PRBool *aCmdLineURLUsed) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCmdLineURLUsed(aCmdLineURLUsed); } \
  NS_IMETHOD SetCmdLineURLUsed(PRBool aCmdLineURLUsed) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCmdLineURLUsed(aCmdLineURLUsed); } \
  NS_IMETHOD SetWebShellWindow(nsIDOMWindowInternal *aWindow) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWebShellWindow(aWindow); } \
