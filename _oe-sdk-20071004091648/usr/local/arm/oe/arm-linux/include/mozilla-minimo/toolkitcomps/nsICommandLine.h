/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/toolkit/components/commandlines/public/nsICommandLine.idl
 */
...
class NS_NO_VTABLE nsICommandLine : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICOMMANDLINE_IID)
  ...
  NS_IMETHOD GetArgument(PRInt32 aIndex, nsAString & _retval) = 0;
  ...
  NS_IMETHOD FindFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRInt32 *_retval) = 0;
  ...
  NS_IMETHOD RemoveArguments(PRInt32 aStart, PRInt32 aEnd) = 0;
  ...
  NS_IMETHOD HandleFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRBool *_retval) = 0;
  ...
  NS_IMETHOD HandleFlagWithParam(const nsAString & aFlag, PRBool aCaseSensitive, nsAString & _retval) = 0;
  ...
  NS_IMETHOD GetPreventDefault(PRBool *aPreventDefault) = 0;
  NS_IMETHOD SetPreventDefault(PRBool aPreventDefault) = 0;
...
#define NS_DECL_NSICOMMANDLINE \
  ...
  NS_IMETHOD GetArgument(PRInt32 aIndex, nsAString & _retval); \
  NS_IMETHOD FindFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRInt32 *_retval); \
  NS_IMETHOD RemoveArguments(PRInt32 aStart, PRInt32 aEnd); \
  NS_IMETHOD HandleFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRBool *_retval); \
  NS_IMETHOD HandleFlagWithParam(const nsAString & aFlag, PRBool aCaseSensitive, nsAString & _retval); \
  NS_IMETHOD GetState(PRUint32 *aState); \
  NS_IMETHOD GetPreventDefault(PRBool *aPreventDefault); \
  NS_IMETHOD SetPreventDefault(PRBool aPreventDefault); \
...
#define NS_FORWARD_NSICOMMANDLINE(_to) \
  ...
  NS_IMETHOD GetArgument(PRInt32 aIndex, nsAString & _retval) { return _to GetArgument(aIndex, _retval); } \
  NS_IMETHOD FindFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRInt32 *_retval) { return _to FindFlag(aFlag, aCaseSensitive, _retval); } \
  NS_IMETHOD RemoveArguments(PRInt32 aStart, PRInt32 aEnd) { return _to RemoveArguments(aStart, aEnd); } \
  NS_IMETHOD HandleFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRBool *_retval) { return _to HandleFlag(aFlag, aCaseSensitive, _retval); } \
  NS_IMETHOD HandleFlagWithParam(const nsAString & aFlag, PRBool aCaseSensitive, nsAString & _retval) { return _to HandleFlagWithParam(aFlag, aCaseSensitive, _retval); } \
  NS_IMETHOD GetState(PRUint32 *aState) { return _to GetState(aState); } \
  NS_IMETHOD GetPreventDefault(PRBool *aPreventDefault) { return _to GetPreventDefault(aPreventDefault); } \
  NS_IMETHOD SetPreventDefault(PRBool aPreventDefault) { return _to SetPreventDefault(aPreventDefault); } \
...
#define NS_FORWARD_SAFE_NSICOMMANDLINE(_to) \
  ...
  NS_IMETHOD GetArgument(PRInt32 aIndex, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetArgument(aIndex, _retval); } \
  NS_IMETHOD FindFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindFlag(aFlag, aCaseSensitive, _retval); } \
  NS_IMETHOD RemoveArguments(PRInt32 aStart, PRInt32 aEnd) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveArguments(aStart, aEnd); } \
  NS_IMETHOD HandleFlag(const nsAString & aFlag, PRBool aCaseSensitive, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleFlag(aFlag, aCaseSensitive, _retval); } \
  NS_IMETHOD HandleFlagWithParam(const nsAString & aFlag, PRBool aCaseSensitive, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleFlagWithParam(aFlag, aCaseSensitive, _retval); } \
  NS_IMETHOD GetState(PRUint32 *aState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetState(aState); } \
  NS_IMETHOD GetPreventDefault(PRBool *aPreventDefault) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPreventDefault(aPreventDefault); } \
  NS_IMETHOD SetPreventDefault(PRBool aPreventDefault) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPreventDefault(aPreventDefault); } \
