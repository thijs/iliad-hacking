/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/layout/xul/base/src/tree/public/nsITreeBoxObject.idl
 */
...
class NS_NO_VTABLE nsITreeBoxObject : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetRowWidth(PRInt32 *aRowWidth) = 0;

  /**
   * Get the pixel position of the horizontal scrollbar. 
   */
  /* readonly attribute long horizontalPosition; */
  NS_IMETHOD GetHorizontalPosition(PRInt32 *aHorizontalPosition) = 0;
  ...
  NS_IMETHOD EnsureCellIsVisible(PRInt32 row, nsITreeColumn *col) = 0;
  ...
  NS_IMETHOD ScrollToCell(PRInt32 row, nsITreeColumn *col) = 0;
  ...
  NS_IMETHOD ScrollToHorizontalPosition(PRInt32 horizontalPosition) = 0;
...
#define NS_DECL_NSITREEBOXOBJECT \
  ...
  NS_IMETHOD GetRowWidth(PRInt32 *aRowWidth); \
  NS_IMETHOD GetHorizontalPosition(PRInt32 *aHorizontalPosition); \
  ...
  NS_IMETHOD EnsureCellIsVisible(PRInt32 row, nsITreeColumn *col); \
  NS_IMETHOD ScrollToRow(PRInt32 index); \
  NS_IMETHOD ScrollByLines(PRInt32 numLines); \
  NS_IMETHOD ScrollByPages(PRInt32 numPages); \
  NS_IMETHOD ScrollToCell(PRInt32 row, nsITreeColumn *col); \
  NS_IMETHOD ScrollToColumn(nsITreeColumn *col); \
  NS_IMETHOD ScrollToHorizontalPosition(PRInt32 horizontalPosition); \
...
#define NS_FORWARD_NSITREEBOXOBJECT(_to) \
  ...
  NS_IMETHOD GetRowWidth(PRInt32 *aRowWidth) { return _to GetRowWidth(aRowWidth); } \
  NS_IMETHOD GetHorizontalPosition(PRInt32 *aHorizontalPosition) { return _to GetHorizontalPosition(aHorizontalPosition); } \
  ...
  NS_IMETHOD EnsureCellIsVisible(PRInt32 row, nsITreeColumn *col) { return _to EnsureCellIsVisible(row, col); } \
  ...
  NS_IMETHOD ScrollToCell(PRInt32 row, nsITreeColumn *col) { return _to ScrollToCell(row, col); } \
  NS_IMETHOD ScrollToColumn(nsITreeColumn *col) { return _to ScrollToColumn(col); } \
  NS_IMETHOD ScrollToHorizontalPosition(PRInt32 horizontalPosition) { return _to ScrollToHorizontalPosition(horizontalPosition); } \
...
#define NS_FORWARD_SAFE_NSITREEBOXOBJECT(_to) \
  ...
  NS_IMETHOD GetRowWidth(PRInt32 *aRowWidth) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowWidth(aRowWidth); } \
  NS_IMETHOD GetHorizontalPosition(PRInt32 *aHorizontalPosition) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHorizontalPosition(aHorizontalPosition); } \
  ...
  NS_IMETHOD EnsureCellIsVisible(PRInt32 row, nsITreeColumn *col) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnsureCellIsVisible(row, col); } \
  ...
  NS_IMETHOD ScrollToCell(PRInt32 row, nsITreeColumn *col) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToCell(row, col); } \
  NS_IMETHOD ScrollToColumn(nsITreeColumn *col) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToColumn(col); } \
  NS_IMETHOD ScrollToHorizontalPosition(PRInt32 horizontalPosition) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToHorizontalPosition(horizontalPosition); } \
