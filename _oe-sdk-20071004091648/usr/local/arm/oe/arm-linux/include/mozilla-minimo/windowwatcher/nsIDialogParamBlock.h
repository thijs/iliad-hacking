/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/embedding/components/windowwatcher/public/nsIDialogParamBlock.idl
 */
...
#define NS_FORWARD_NSIDIALOGPARAMBLOCK(_to) \
  NS_IMETHOD GetInt(PRInt32 inIndex, PRInt32 *_retval) { return _to GetInt(inIndex, _retval); } \
  NS_IMETHOD SetInt(PRInt32 inIndex, PRInt32 inInt) { return _to SetInt(inIndex, inInt); } \
  NS_IMETHOD SetNumberStrings(PRInt32 inNumStrings) { return _to SetNumberStrings(inNumStrings); } \
  NS_IMETHOD GetString(PRInt32 inIndex, PRUnichar **_retval) { return _to GetString(inIndex, _retval); } \
  NS_IMETHOD SetString(PRInt32 inIndex, const PRUnichar *inString) { return _to SetString(inIndex, inString); } \
...
#define NS_FORWARD_SAFE_NSIDIALOGPARAMBLOCK(_to) \
  NS_IMETHOD GetInt(PRInt32 inIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInt(inIndex, _retval); } \
  NS_IMETHOD SetInt(PRInt32 inIndex, PRInt32 inInt) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetInt(inIndex, inInt); } \
  NS_IMETHOD SetNumberStrings(PRInt32 inNumStrings) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNumberStrings(inNumStrings); } \
  NS_IMETHOD GetString(PRInt32 inIndex, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetString(inIndex, _retval); } \
  NS_IMETHOD SetString(PRInt32 inIndex, const PRUnichar *inString) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetString(inIndex, inString); } \
