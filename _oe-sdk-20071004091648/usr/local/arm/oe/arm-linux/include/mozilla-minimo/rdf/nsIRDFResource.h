/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFResource.idl
 */
...
#define NS_DECL_NSIRDFRESOURCE \
  ...
  NS_IMETHOD EqualsString(const char *aURI, PRBool *_retval); \
...
#define NS_FORWARD_NSIRDFRESOURCE(_to) \
  ...
  NS_IMETHOD EqualsString(const char *aURI, PRBool *_retval) { return _to EqualsString(aURI, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFRESOURCE(_to) \
  ...
  NS_IMETHOD EqualsString(const char *aURI, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsString(aURI, _retval); } \
