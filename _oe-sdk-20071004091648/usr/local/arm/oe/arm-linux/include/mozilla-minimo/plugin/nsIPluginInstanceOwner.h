/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/modules/plugin/base/public/nsIPluginInstanceOwner.idl
 */
...
class nsIPluginInstanceOwner : public nsISupports {
 public: 
  ...
  NS_IMETHOD PluginNotAvailable(const char *aMimeType) = 0;
...
#define NS_FORWARD_NSIPLUGININSTANCEOWNER(_to) \
  ...
  NS_IMETHOD PluginNotAvailable(const char *aMimeType) { return _to PluginNotAvailable(aMimeType); } 
...
#define NS_FORWARD_SAFE_NSIPLUGININSTANCEOWNER(_to) \
  ...
  NS_IMETHOD PluginNotAvailable(const char *aMimeType) { return !_to ? NS_ERROR_NULL_POINTER : _to->PluginNotAvailable(aMimeType); } 
...
/* void pluginNotAvailable (in string aMimeType); */
NS_IMETHODIMP nsPluginInstanceOwner::PluginNotAvailable(const char *aMimeType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
