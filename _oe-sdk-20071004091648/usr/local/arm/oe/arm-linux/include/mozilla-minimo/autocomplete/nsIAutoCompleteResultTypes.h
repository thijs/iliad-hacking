/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/toolkit/components/autocomplete/public/nsIAutoCompleteResultTypes.idl
 */
...
class NS_NO_VTABLE nsIAutoCompleteBaseResult : public nsIAutoCompleteResult {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IAUTOCOMPLETEBASERESULT_IID)
...
class NS_NO_VTABLE nsIAutoCompleteMdbResult : public nsIAutoCompleteBaseResult {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IAUTOCOMPLETEMDBRESULT_IID)
