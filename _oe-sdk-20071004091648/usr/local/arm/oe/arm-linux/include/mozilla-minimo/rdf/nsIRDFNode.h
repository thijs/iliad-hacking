/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFNode.idl
 */
...
#define NS_DECL_NSIRDFNODE \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFNODE(_to) \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval) { return _to EqualsNode(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFNODE(_to) \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsNode(aNode, _retval); } 
