/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFService.idl
 */
...
class NS_NO_VTABLE nsIRDFService : public nsISupports {
 public: 
  ...
  NS_IMETHOD IsAnonymousResource(nsIRDFResource *aResource, PRBool *_retval) = 0;
...
#define NS_DECL_NSIRDFSERVICE \
  ...
  NS_IMETHOD GetDateLiteral(PRInt64 aValue, nsIRDFDate **_retval); \
  NS_IMETHOD GetIntLiteral(PRInt32 aValue, nsIRDFInt **_retval); \
  NS_IMETHOD GetBlobLiteral(const PRUint8 * aValue, PRInt32 aLength, nsIRDFBlob **_retval); \
  NS_IMETHOD IsAnonymousResource(nsIRDFResource *aResource, PRBool *_retval); \
  NS_IMETHOD RegisterResource(nsIRDFResource *aResource, PRBool aReplace); \
  NS_IMETHOD UnregisterResource(nsIRDFResource *aResource); \
  NS_IMETHOD RegisterDataSource(nsIRDFDataSource *aDataSource, PRBool aReplace); \
...
#define NS_FORWARD_NSIRDFSERVICE(_to) \
  ...
  NS_IMETHOD GetDateLiteral(PRInt64 aValue, nsIRDFDate **_retval) { return _to GetDateLiteral(aValue, _retval); } \
  NS_IMETHOD GetIntLiteral(PRInt32 aValue, nsIRDFInt **_retval) { return _to GetIntLiteral(aValue, _retval); } \
  ...
  NS_IMETHOD IsAnonymousResource(nsIRDFResource *aResource, PRBool *_retval) { return _to IsAnonymousResource(aResource, _retval); } \
  NS_IMETHOD RegisterResource(nsIRDFResource *aResource, PRBool aReplace) { return _to RegisterResource(aResource, aReplace); } \
  NS_IMETHOD UnregisterResource(nsIRDFResource *aResource) { return _to UnregisterResource(aResource); } \
  NS_IMETHOD RegisterDataSource(nsIRDFDataSource *aDataSource, PRBool aReplace) { return _to RegisterDataSource(aDataSource, aReplace); } \
...
#define NS_FORWARD_SAFE_NSIRDFSERVICE(_to) \
  ...
  NS_IMETHOD GetDateLiteral(PRInt64 aValue, nsIRDFDate **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDateLiteral(aValue, _retval); } \
  NS_IMETHOD GetIntLiteral(PRInt32 aValue, nsIRDFInt **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIntLiteral(aValue, _retval); } \
  ...
  NS_IMETHOD IsAnonymousResource(nsIRDFResource *aResource, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsAnonymousResource(aResource, _retval); } \
  NS_IMETHOD RegisterResource(nsIRDFResource *aResource, PRBool aReplace) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterResource(aResource, aReplace); } \
  NS_IMETHOD UnregisterResource(nsIRDFResource *aResource) { return !_to ? NS_ERROR_NULL_POINTER : _to->UnregisterResource(aResource); } \
  NS_IMETHOD RegisterDataSource(nsIRDFDataSource *aDataSource, PRBool aReplace) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterDataSource(aDataSource, aReplace); } \
