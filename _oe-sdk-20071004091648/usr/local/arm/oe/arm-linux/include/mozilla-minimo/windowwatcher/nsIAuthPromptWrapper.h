/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/embedding/components/windowwatcher/public/nsIAuthPromptWrapper.idl
 */
 ...
 * @status
 */
class NS_NO_VTABLE nsIAuthPromptWrapper : public nsIAuthPrompt {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IAUTHPROMPTWRAPPER_IID)
  ...
  NS_IMETHOD SetPromptDialogs(nsIPrompt *dialogs) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIAUTHPROMPTWRAPPER \
  NS_IMETHOD SetPromptDialogs(nsIPrompt *dialogs); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAUTHPROMPTWRAPPER(_to) \
  NS_IMETHOD SetPromptDialogs(nsIPrompt *dialogs) { return _to SetPromptDialogs(dialogs); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAUTHPROMPTWRAPPER(_to) \
  NS_IMETHOD SetPromptDialogs(nsIPrompt *dialogs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPromptDialogs(dialogs); } 
