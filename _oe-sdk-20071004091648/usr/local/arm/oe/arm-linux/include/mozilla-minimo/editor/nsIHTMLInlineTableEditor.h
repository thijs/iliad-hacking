/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/editor/idl/nsIHTMLInlineTableEditor.idl
 */
...
class NS_NO_VTABLE nsIHTMLInlineTableEditor : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IHTMLINLINETABLEEDITOR_IID)
  ...
  NS_IMETHOD GetInlineTableEditingEnabled(PRBool *aInlineTableEditingEnabled) = 0;
  NS_IMETHOD SetInlineTableEditingEnabled(PRBool aInlineTableEditingEnabled) = 0;
...
#define NS_DECL_NSIHTMLINLINETABLEEDITOR \
  NS_IMETHOD GetInlineTableEditingEnabled(PRBool *aInlineTableEditingEnabled); \
  NS_IMETHOD SetInlineTableEditingEnabled(PRBool aInlineTableEditingEnabled); \
...
#define NS_FORWARD_NSIHTMLINLINETABLEEDITOR(_to) \
  NS_IMETHOD GetInlineTableEditingEnabled(PRBool *aInlineTableEditingEnabled) { return _to GetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
  NS_IMETHOD SetInlineTableEditingEnabled(PRBool aInlineTableEditingEnabled) { return _to SetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
...
#define NS_FORWARD_SAFE_NSIHTMLINLINETABLEEDITOR(_to) \
  NS_IMETHOD GetInlineTableEditingEnabled(PRBool *aInlineTableEditingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
  NS_IMETHOD SetInlineTableEditingEnabled(PRBool aInlineTableEditingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetInlineTableEditingEnabled(aInlineTableEditingEnabled); } \
