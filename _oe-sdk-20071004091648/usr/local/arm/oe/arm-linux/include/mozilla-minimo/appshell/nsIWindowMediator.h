/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/xpfe/appshell/public/nsIWindowMediator.idl
 */
...
class NS_NO_VTABLE nsIWindowMediator : public nsISupports {
  ...
  */
  ...
  NS_IMETHOD GetMostRecentWindow(const PRUnichar *aWindowType, nsIDOMWindowInternal **_retval) = 0;
...
#define NS_DECL_NSIWINDOWMEDIATOR \
  ...
  NS_IMETHOD GetMostRecentWindow(const PRUnichar *aWindowType, nsIDOMWindowInternal **_retval); \
...
#define NS_FORWARD_NSIWINDOWMEDIATOR(_to) \
  ...
  NS_IMETHOD GetMostRecentWindow(const PRUnichar *aWindowType, nsIDOMWindowInternal **_retval) { return _to GetMostRecentWindow(aWindowType, _retval); } \
...
#define NS_FORWARD_SAFE_NSIWINDOWMEDIATOR(_to) \
  ...
  NS_IMETHOD GetMostRecentWindow(const PRUnichar *aWindowType, nsIDOMWindowInternal **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMostRecentWindow(aWindowType, _retval); } \
