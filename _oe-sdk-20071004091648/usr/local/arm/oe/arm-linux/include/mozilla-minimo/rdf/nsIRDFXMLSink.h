/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /data/workareas/matthijs/svn/openembedded/build/tmp/work/minimo-0.0cvs20051025-r9/mozilla/rdf/base/idl/nsIRDFXMLSink.idl
 */
...
class NS_NO_VTABLE nsIRDFXMLSinkObserver : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IRDFXMLSINKOBSERVER_IID)
...
class NS_NO_VTABLE nsIRDFXMLSink : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IRDFXMLSINK_IID)
