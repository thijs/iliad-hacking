...
./configure --host=arm-linux --build=i686 --prefix=/usr \
        --with-mozilla-includes=/usr/local/arm/oe/arm-linux/include/mozilla-minimo \
        --with-mozilla-libs=/usr/local/arm/oe/arm-linux/lib/mozilla-minimo
